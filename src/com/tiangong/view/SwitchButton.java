...
import com.tiangong.view.SwitchButtonAnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
	...
	private void fetchDrawableFromAttr(TypedArray ta) {
		...
		mConf.setThumbDrawable(fetchDrawable(ta, R.styleable.SwitchButton_thumbDrawable, R.styleable.SwitchButton_thumbColor, SwitchButtonConfiguration.Default.DEFAULT_THUMB_COLOR));
	}
